...
class GenericViewSet1(mixins.CreateModelMixin,
    ...
    def create(self, request, *args, **kwargs):
        ...
        general_response = rsp.Response(True, serializer.data).generate_response()
        return Response(general_response, status=status.HTTP_201_CREATED, headers=headers)
    ...
    def list(self, request, *args, **kwargs):
        ...
        if page is not None:
            ...
            general_response = rsp.Response(True, self.get_paginated_response(serializer.data).data).generate_response()
